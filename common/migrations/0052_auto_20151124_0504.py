...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='allegation',
            name='cat',
            field=models.ForeignKey(to='common.AllegationCategory', blank=True, null=True),
        ),
        migrations.AlterField(
            model_name='allegation',
            name='city',
