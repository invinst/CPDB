...
describe('AllegationPresenter', function () {
  it('#crid: should return crid', function () {
  ...
  it('#crid: should return Unknown if there is no crid', function () {
  ...
  it('#incidentDate: should return moment incident date', function () {
  ...
  it('#incidentDateDisplay: should return incident date present', function () {
    var date = '2012-01-19T09:11:00';
  ...
  it('#incidentDateDisplay: should return unknown date if there is invalid date', function () {
    var date = 'invalid';
    var allegation = f.create('Allegation', { 'incident_date': date });
    var presenter = AllegationPresenter(allegation);
  ...
  it('#address: should return full address', function () {
    var add1 = 'add1';
    var add2 = 'add2';
  ...
  it('#address: should return partial address if only one address is provided', function () {
    var add1 = 'add1';
    var add2 = 'add2';
  ...
  it('#address: should return empty address if there is no address', function () {
    var allegation = f.create('Allegation');
    var presenter = AllegationPresenter(allegation);
  ...
  it('#city: should return city', function () {
    var city = 'city';
  ...
  it('#city: should return empty string if city is not provided', function () {
    var allegation = f.create('Allegation');
    var presenter = AllegationPresenter(allegation);
  ...
  it('#locationType: should return locationType', function () {
  ...
  it('#locationType: should return enpty string if no location provided', function () {
    var allegation = f.create('Allegation');
    var presenter = AllegationPresenter(allegation);
  ...
  it('#beat: should return beat name', function () {
  ...
  it('#beat: should return empty string if there is no beat name', function () {
  ...
  it('#documentId: should return document id ', function () {
  ...
  it('#documentId: should return empty if there is no document id', function () {
    var documentId = 0;
    var allegation = f.create('Allegation', { 'document_id': documentId });
    var presenter = AllegationPresenter(allegation);
  ...
  it('#documentNormalizedTitle: should return document normalized title', function () {
  ...
  it('#documentNormalizedTitle: should return empty if there is no document normalized title', function () {
  ...
  it('#hasLocation: should return true if have any address properties', function () {
  ...
  it('#hasLocation: should return false if there is no address properties', function () {
    var allegation = f.create('Allegation', { 'beat': null, 'location': null, 'add1': null, 'add2': null, 'city': null,
      'point': null});
    var presenter = AllegationPresenter(allegation);
  ...
  it('#hasFullAddress: should return true if there is full address', function () {
  ...
  it('#hasFullAddress: should return false if there is only one address', function () {
  ...
  it('#hasFullAddress: should return false if there is empty address', function () {
