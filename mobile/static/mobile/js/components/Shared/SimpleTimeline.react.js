      ...
      <div className='simple-timeline'>
        <svg x="0px" y="0px" viewBox="0 0 400 200" enable-background="new 0 0 400 200"
          ...
          <g>
            ...
            <rect className="line" fill="black" x="322.5" y="86" width="2" height="57" />
            <rect className="line" fill="black" x="187.5" y="106" width="2" height="36" />
            <rect className="line" fill="black" x="52.5" y="101" width="2" height="41" />

            <rect className="rect-wrapper" fill="#ffffff" x="148" y="68" width="81" height="46" />
            <rect className="rect-wrapper" fill="#ffffff" x="267" y="24" width="114" height="55" />
            <rect className="rect-wrapper" fill="#ffffff" x="6.5" y="51" width="120" height="46" />
