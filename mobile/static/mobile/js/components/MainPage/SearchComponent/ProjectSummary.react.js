    ...
    return (
      <div className={cx('project-summary animation', {'top-left': topLeft})}>
          ...
          <div className='cpdb-description'>
            ...
            <div className='paragraph'>Search here for complaint records released under FOIA by the Chicago Police Department. Type the name of
            a police officer, badge number, or CRID number.</div>
          </div>
        </div>
    );
  }
