...
class OfficerAllegationService(object):
    ...
    def get_officer_allegations(officer_id):
        ...
        officer_allegations = OfficerAllegation.objects.filter(allegation__pk__in=allegation_pks)
        officer_allegations = sorted(list(officer_allegations.prefetch_related('cat')), key=lambda x: x.allegation_id)
