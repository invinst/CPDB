...
class MobileAllegationTest(SimpleTestCase):
    ...
    def test_successfully_call_the_api(self):
        ...
        data['complaining_witnesses'][0]['race']\
            .should.be.equal(complaining_witness.race)
        data['complaining_witnesses'][0]['gender']\
            .should.be.equal(complaining_witness.gender)
        data['complaining_witnesses'][0]['age']\
            .should.be.equal(complaining_witness.age)
    ...
    def test_officer_should_be_ordered_by_number_of_involved_allegations(self):
        ...
        ordered_officers_list = [
            officer_3_complaints.id, officer_2_complaints.id,
            officer_1_complaint.id]
