...
class AreaFactory(factory.django.DjangoModelFactory):
    ...
    name = factory.Sequence(lambda n: fake.word())
...
class OfficerFactory(factory.django.DjangoModelFactory):
    ...
    officer_first = factory.Sequence(lambda n: fake.word())
    officer_last = factory.Sequence(lambda n: fake.word())
...
class DownloadFactory(factory.django.DjangoModelFactory):
    class Meta:
        model = Download
    query = factory.Sequence(lambda n: fake.word())
