...
class AllegationSearchViewTest(SimpleTestCase):
    def test_search_officer_should_redirect_to_data_tool_page(self):
        ...
        response = self.client.get(reverse('allegation:search-q-page', kwargs={'term': officer.officer_first}))
    ...
    def test_search_no_result_should_redirect_to_homepage(self):
        response = self.client.get(reverse('allegation:search-q-page', kwargs={'term': 'no_result'}))
