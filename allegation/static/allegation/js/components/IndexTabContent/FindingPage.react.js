      ...
      <div>
        <div className='row section map-section'>
          <div className='container'>
            ...
            <div className='col-sm-6 map-explain'>
              <p>
                The Citizens Police Data Project houses police disciplinary information obtained from
                the City of Chicago.
              </p>
              <p>
              ...
              <p>
                This is an evolving platform. We are constantly adding data, and we welcome questions, feedback,
                and collaboration.
              </p>
            </div>
          </div>
        ...
        <div className='row section'>
          <div className='container'>
            <div className='col-sm-6'>
              ...
              <p>
                28,567 allegations of misconduct were filed against Chicago Police Department officers
                between March 2011 and September 2015.
              </p>
              <p>
            ...
            <div className='col-sm-6'>
              ...
              <p>
                Of those cases in which discipline is imposed, the vast majority result in a reprimand
                or a suspension of less than one week.
              </p>
            </div>
          </div>
        </div>
        <div className='row section'>
          <div className='container'>
            <div className='col-sm-12'>
              ...
              <p>
                Repeat officers—those with 10 or more complaints—make up about 10% of the force
                but receive 30% of all complaints. They average 3.7x as many complaints per officer
                as the rest of the force.
              </p>
            </div>
          </div>
        </div>
        <div className='row section'>
          <div className='container'>
            ...
            <div className='col-sm-6'>
              <p>
                Black Chicagoans filed 61% of all complaints in the database, but make up only 25%
        ...
        <div className='row section font-size-19'>
          <div className='container'>
            <div className='col-sm-6'>
              <Link data-target='story' className='pointer tab-navigate' to='story' onClick={ this.navigate }>
                <img src='/static/allegation/img/story-ad.png' alt={ true } />
              </Link>
              <Link data-target='story' className='tab-navigate btn full-width' to='story' onClick={ this.navigate }>
                Stories
              </Link>
            </div>
            <div className='col-sm-6'>
